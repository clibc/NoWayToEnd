...
set libs=..\Dependencies\SDL2\lib\SDL2.lib ..\Dependencies\SDL2\lib\SDL2main.lib ..\Dependencies\SDL2_image\lib\x64\SDL2_image.lib ..\Dependencies\SDL2_ttf\lib\x64\SDL2_ttf.lib Shell32.lib
